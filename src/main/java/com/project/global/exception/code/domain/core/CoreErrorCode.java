...
public enum CoreErrorCode implements BaseErrorCode {
	...
	PHONE_NUMBER_GENERATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "SUB_003", "사용 가능한 전화번호 생성에 실패했습니다. (재시도 횟수 초과)"),
	ENCRYPTION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "SUB_004", "암호화/복호화 처리 중 오류가 발생했습니다."),
	;
