...
public class PlanService {
  ...
  public void joinSubscription(Long customerId, Long planId) {
    ...
    // 회선 생성
    Subscription newSub =
        Subscription.builder().customer(customer).phoneNumber(phoneNumberEnc).clock(clock).build();
  ...
  private String determinePhoneNumber(Customer customer) {
    ...
    long activeCount =
        subscriptionRepository.countByCustomerAndStatus(customer, SubscriptionStatus.ACTIVE);
